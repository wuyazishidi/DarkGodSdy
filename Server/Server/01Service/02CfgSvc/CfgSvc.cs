...
public class CfgSvc {
    ...
    private void InitGuideCfg() {
        ...
        doc.Load(@"H:\Jwp\Unity\ResDarkGod\Last\Client\Assets\Resources\ResCfgs\guide.xml");
    ...
    private void InitStrongCfg() {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"H:\Jwp\Unity\ResDarkGod\Last\Client\Assets\Resources\ResCfgs\strong.xml");
    ...
    private void InitTaskRewrdCfg() {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"H:\Jwp\Unity\ResDarkGod\Last\Client\Assets\Resources\ResCfgs\taskreward.xml");
    ...
    private void InitMapCfg() {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"H:\Jwp\Unity\ResDarkGod\Last\Client\Assets\Resources\ResCfgs\map.xml");
